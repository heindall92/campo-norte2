...
```bash
npm test          # vitest run   — 269 (planta + inventory + holds/FEFO/counts + ASN/QC + slotting + MIN/MAX + packing/SSCC + shipping/mock + RBAC/tenant + productividad/costes/alertas)
npm run lint      # oxlint
