...
```bash
npm test          # vitest run   — 273 (planta + inventory + holds/FEFO/counts + ASN/QC + slotting + MIN/MAX + packing/SSCC + shipping/mock + dock calendar + RBAC/tenant + productividad/costes/alertas)
npm run lint      # oxlint
